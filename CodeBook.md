...
The transformations are achieved by the script called [run_analysis.R](https://github.com/DirkHaehnel/GettingAndCleaningData/blob/master/runAnalysis.R), which:
