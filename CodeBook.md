...
The transformations are achieved by the script called [RunAnalysis.R](https://github.com/DirkHaehnel/GettingAndCleaningData/blob/master/RunAnalysis.R), which:
